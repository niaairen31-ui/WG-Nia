...
#
# Body decomposed into cockpit/play.py (BRIEF-0027-b): every `_say_*` helper
# beyond turn setup and stream construction lives there, along the phase
# seams documented above. `play` is imported lazily (inside the function
# body) to avoid a circular import — play.py imports helpers from this
# module, so it can only be loaded once app.py has finished executing.
